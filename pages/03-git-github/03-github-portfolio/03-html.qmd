...
image: /images/earth-analytics/git-version-control/github-pages/lesson-portfolio-content.jpeg
...
![Web developer tools](/images/earth-analytics/git-version-control/github-pages/web-developer-tools.png)
...
![Super-cool satellite imagery](/images/cool_satellite_image.jpeg) <!-- <2> -->
...
src="/images/cool_satellite_image.jpeg" alt-text="Super-cool satellite imagery">
<p>Some text and <a 
...
<img 
  src="/images/cool_satellite_image.jpeg" 
...
```markdown
![Super-cute pika!](/images/pika.jpg)
```
...
When using `px`, keep in mind that others may be viewing your webpage on different devices (e.g. phone vs. computer). `px` units are pegged to the resolution of the screen, so this can result in vastly different sizes on different devices.
...
![Web developer tools with the device simulator highlighted](/images/earth-analytics/git-version-control/github-pages/web-developer-tools-device.png)
:::
...
::: {.callout}
```html
Change the <span style="color: red; font-size: 2rem"> color and font size of a word</span>
```
