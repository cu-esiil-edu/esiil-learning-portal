...
:::
  ...
  5. Select the `Commit` button.
     ...
     ![Select `Commit`.](/img/earth-analytics/git-version-control/pr-activity/commit.png)
  ...
  6. Make sure to select `Make changes in another branch`. This will create a branch with your changes in it! You can name the branch anything you want other than `main`, but the default (`<your-username>-patch-1`) is fine.
     ...
     ![Select Make changes in another branch.](/img/earth-analytics/git-version-control/pr-activity/new-branch.png)
  ...
  7. Click the `Propose changes` button.
     ...
     ![Select `Propose Changes`.](/img/earth-analytics/git-version-control/pr-activity/propose-changes.png)
