...
When collaborating, it's important to be able to see potential changes and discuss them with others. A **pull request** (referred to as a **PR**) is a way for you to **suggest** changes to code in a GitHub repository. It allows you and your collaborators to:
...
For the purposes of this page, pretend that you are working with your colleague on a project. You have been asked to make some changes to a README.md file in your collaborator's repository. 
...
First, make your changes **in a new branch**:
  ...
  1. Open up the main page of the repository on GitHub, making sure to select the `Code` tab.
  2. Click on the `README.md` file.
  3. Click on the edit button (pencil symbol) in the upper right.
  4. Make your changes and click `Commit changes`
  5. **Select the option to commit changes to a new branch.** You probably won't have permission to commit to main in someone else's repository...but just in case make sure to check that you aren't unilaterally making changes!
  6. Leave a message describing what you did.
  7. Confirm by clicking `Commit`.
...
Now, your changes are in a branch. If you want your collaborator to incorporate them into the main branch, you should submit a pull request:
  ...
  2. You should see a banner stating that there are changes in the new branch you created, and asking if you want to create a pull request. The easiest way to create a pull request is to click on the link in that banner.
  3. Leave a message describing the changes you made.
  4. Click `Create Pull Request`.

### Cloned

First, you will need to create a fork of your collaborator's repository to make changes in:
