...
```{python}
coastlines_url = "https://naciscdn.org/naturalearth/50m/physical/ne_50m_coastline.zip"
...
# Open a second layer
et.data.get_data(
    url='https://naciscdn.org/naturalearth/50m/cultural/ne_50m_populated_places_simple.zip')
...
country_data_url = "https://naciscdn.org/naturalearth/50m/cultural/ne_50m_admin_0_countries.zip"
et.data.get_data(url=country_data_url)
