...
![An open science workflow highlighting the roles of data, code, and workflows. Source: Max Joseph, Earth Lab at University of Colorado, Boulder.](/img/courses/earth-analytics/bootcamp/open-science/workflow.png){fig-alt="This figure shows an open science workflow, highlighting the roles of data, code, and workflows. Source: Max Joseph, Earth Lab at University of Colorado, Boulder."}

::: {.callout title="Importance of Reproducibility in Science"}
...
{{< video https://www.youtube.com/watch?v=NGFO0kdbZmk&feature=youtu.be >}}
:::
