...
description: Open reproducible science refers to developing workflows that others can easily understand and use. It enables you to build on others' work rather than starting from scratch. Learn about the importance and benefits of open reproducible science.
authors:
  - Jenny Palomino
  - Leah Wasser
  - Max Joseph
...
<figure>
 <a href="/images/courses/earth-analytics/bootcamp/open-science/workflow.png">
 <img src="/images/courses/earth-analytics/bootcamp/open-science/workflow.png" alt="This figure shows an open science workflow, highlighting the roles of data, code, and workflows. Source: Max Joseph, Earth Lab at University of Colorado, Boulder."></a>
...
::: {.callout-video title="Importance of Reproducibility in Science"}
<a 
  href="https://www.youtube.com/watch?v=NGFO0kdbZmk&feature=youtu.be" 
  target="_blank">
    <img 
      src="http://img.youtube.com/vi/NGFO0kdbZmk/0.jpg" 
      alt="Importance of Reproducibility in Science" 
      width="560" height="315" border = "10" />
</a>
...
::: {.callout title="Open Reproducible Science - A Case Study"}
