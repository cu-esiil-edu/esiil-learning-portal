...
description: 'Key tools for open reproducible science include Shell (Bash), git and GitHub, Jupyter, and Python. Learn how these tools help you implement open reproducible science workflows.'
learning-goals:
...
![You can write and run Python code in interactive development environments such as Jupyter Notebook. This image shows how Python code can be organized and run using cells in Jupyter Notebook and how the output is displayed under the executed cells.](/img/earth-analytics/jupyter-interface/python-jupyter-notebook.png)
...
![You can make local copies on your computer of repositories on Github.com, using git commands that you run in the Terminal.](/img/earth-analytics/git-version-control/git-fork-repo.gif)
...
![A Jupyter Notebook file can contain both text documentation as well as programming code, which can be executed interactively within Jupyter Notebook.](/img/courses/earth-analytics/bootcamp/jupyter-interface/notebook-components.png)
...
::: {#fig-jupyter layout-ncol=2}

![Jupyter Notebook (left) is a browser-based interface that allows you to write code in many programming languages, including Python, and add formatted text that describes what the code does using Markdown.](/img/earth-analytics/jupyter-interface/python-jupyter-notebook.png)
![Jupyter Lab (right) provides access to Jupyter Notebook but also allows you to work with multiple documents, including notebook files and other files, at a time.](/img/earth-analytics/jupyter-interface/multiple-notebooks-jupyter-lab.png)
