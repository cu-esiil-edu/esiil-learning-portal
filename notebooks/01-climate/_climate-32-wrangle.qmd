...
::: {.callout-read .column-margin title="Packages need to be installed and imported."}
...
Next, lets download some climate data from {{< meta params.location >}} to practice with. The data will come in comma-separate value, or CSV format.

::: {.callout-read .column-margin title="Tabular data"}
Learn more about tabular data and CSV files in the [this article on text files in Earth Data Science](https://www.earthdatascience.org/courses/intro-to-earth-data-science/file-formats/use-text-files/).
:::
