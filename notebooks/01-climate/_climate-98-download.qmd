...
::: {.callout-task title="Format your URL for readability"}
  ...
  2. Reformat the URL so that it adheres to the [79-character PEP-8 line limit](https://peps.python.org/pep-0008/#maximum-line-length). If you are using GitHub Codespaces, you should see two vertical lines in each cell -- don't let your code go past the second line.
...
ncei_path = project.get_data(url=ncei_url, filename=ncei_filename)
ncei_path
```
