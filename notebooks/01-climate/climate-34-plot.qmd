---
title: Climate coding challenge, Part 4
jupyter: python3
format:
  ipynb:
    output-file: "Get Started with Open Reproducible Science, Part 4!"
---
...
#| echo: false
#| eval: false
__param_location: "TEST LOCATION"
```
...
climate_df.plot(
    y='TOBS',
    title=f'Daily Temperature in {__param_location}',
    xlabel='Date',
...
ann_climate_df.plot(
    y='TOBS',
    title=f'Annual Average Temperature in {__param_location}',
    xlabel='Year',
    ylabel='Temperature ($^\circ$F)'
)
```
