...
```{python}
zip_path = project.project_dir / "tl_2020_us_aitsn.zip"
```
...
::: {.callout-task}
  ...
  1. Replace `"directory-name"` with the actual name of the file you downloaded and put in your project directory.
...
#| template: answer
# Define boundary path
aitsd_path = project.project_dir / "tl_2020_us_aitsn"
