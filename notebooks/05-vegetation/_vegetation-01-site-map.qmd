...
aitsd_gdf = gpd.read_file(project.project_dir / 'subdivision-directory')
...
#| template: answer
# Load in the boundary data
aitsd_gdf = gpd.read_file(project.project_dir / 'tl_2020_us_aitsn')
# Check that it worked
aitsd_gdf
...
gdf = aitsd_gdf.loc[aitsd_gdf.AIANNHCE==identifier].dissolve()
