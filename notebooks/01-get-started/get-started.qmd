...
![Components of open science - accessible, reproducible, inclusive. Image source: [NASA](https://www.earthdata.nasa.gov/esds/open-science/oss-for-eso-workshops)](https://www.earthdata.nasa.gov/s3fs-public/2021-11/Circle_Diagram_UPDATE_2.jpg?VersionId=pFRniRpjtgc_MEXUJKi9_sXLoMsSX.pB){width=50% fig-pos='H'}  (Earth Science Data Systems, 2021)
...
**Then, create a new Markdown cell below this one** using the `+ Code` button in the upper left**

{{< ai conversation >}} In the new cell, answer the following questions using a **numbered list** in Markdown:
