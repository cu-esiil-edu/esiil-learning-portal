...
For this example we're requesting [daily summary data in {{< meta params.01-get-started.location >}} (station ID {{< meta params.01-get-started.station_id >}})](https://www.ncdc.noaa.gov/cdo-web/datasets/GHCND/stations/GHCND:{{< meta params.01-get-started.station_id >}}/detail).
...
ncei_url = (
    ...
    '&dataTypes=TOBS,PRCP'
    f'&stations=USC00050848'
    f'&startDate=1893-10-01'
    f'&endDate=2023-09-30'
    '&units=standard'
)
ncei_url
```
...
with open("get-started-test-data.csv", 'wb') as out_file:
    out_file.write(response.content)
subprocess.run([
    'gh', 'release', 'upload', 'data-release',
    f'get-started-test-data.csv',
