...
```{python}
# Search EarthData for MODIS AOD dataset
auth = earthaccess.login(strategy="interactive", persist=True)
store = earthaccess.Store(auth)
granules = earthaccess.search_data(
    short_name="MOD04_3K", cloud_hosted=True,
    bounding_box=tuple(denver_gdf.total_bounds),
    temporal=("2023-01-01", "2023-01-15"),
)
granules[0]
```
...
path = '/Users/elsa/Downloads/MOD04_3K.A2023001.1655.061.2023002014331.hdf'
# g = gdal.Open(path)
# subdatasets = g.GetSubDatasets()
# subdatasets
xr.open_dataset(f'HDF4_EOS:EOS_SWATH:"{ path }":mod04:Corrected_Optical_Depth_Land', engine='h5netcdf')
```
...
ds = rxr.open_rasterio(f'HDF4_EOS:EOS_SWATH:{ links[0] }:mod04:Optical_Depth_Land_And_Ocean')
ds
```
