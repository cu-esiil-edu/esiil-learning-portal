...
1. Replace `project_title` with the actual project title, `{python}  project_title`
...
Your sample data package included a Shapefile of global **ecoregions**. You should be able to see changes in the number of observations of `{python} species_name` in each ecoregion throughout the year.
